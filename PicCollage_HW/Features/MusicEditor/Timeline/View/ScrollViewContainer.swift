    ...
    var body: some View {
        GeometryReader { geometry in
            ZStack(alignment: .center) {
                // ScrollView
                scrollView(geometryWidth: geometry.size.width)
                // SelectedRangeView
                selectedRangeView(geometryWidth: geometry.size.width)
            }
...
extension ScrollViewContainer {
    private func  selectedRangeView(geometryWidth: CGFloat) -> some View {
        Rectangle()
            .fill(.clear)
            .frame(width: geometryWidth * MusicTimelineView.UIConstants.selectedRangeWidthRatio,
    ...
    private func scrollView(geometryWidth: CGFloat) -> some View {
        let durationRatio = selectedRangeDuration / totalDuration
        let contentSizeWidth = (geometryWidth *  MusicTimelineView.UIConstants.selectedRangeWidthRatio) / durationRatio
